-- ===========================================================================
-- VEORA WELLNESS — combined migration file (0001 through 0005)
--
-- This is NOT a new migration — it's migrations 0001-0005 pasted back to back
-- so they can be run in one shot from the Supabase Dashboard SQL Editor.
-- Run it exactly once, on a fresh project with no existing tables.
--
-- How to run it:
...
-- ============================================================
-- 0001_accounts_packages_payments.sql
-- ============================================================
...
values (
  ...
  '+63 917 324 4355', 'bookings@veora.ph', 'bookings@veora.ph',
...
-- ============================================================
-- 0004_admin_booking_actions.sql
-- ============================================================
...
-- ============================================================
-- 0005_bootstrap_super_admin.sql
-- ============================================================
-- =========================================================================
