import { SEPTEMBER_PRE_OPENING_PROMOTION } from "@/lib/promotion-window";
  ...
  introOffers: [
    {
      ...
      description: "Your introductory Veora class at the existing Discovery Pass rate.",
      includedServices: ["1 class credit", "Valid for 5 days from purchase"],
      conditions: ["Intro pricing is not part of the September pre-opening promotion"],
      recommended: true,
  ...
  singleSessions: [
    {
      ...
      conditions: ["Not included in the September pre-opening promotion"],
  ...
  packages: [
    {
      ...
      price: "₱2,730",
      originalPrice: "₱3,000",
      promotionStartsAt: SEPTEMBER_PRE_OPENING_PROMOTION.startsAt,
      promotionEndsAt: SEPTEMBER_PRE_OPENING_PROMOTION.endsAt,
      sessions: 3,
      validity: "3 classes",
      description: "Three flexible Veora class credits.",
      includedServices: ["3 class credits"],
      conditions: ["September pre-opening price: ₱2,730", "Non-transferable"],
      available: true,
    },
    {
      ...
      conditions: ["September pre-opening price: ₱4,914", "Non-transferable"],
      available: true,
    },
  ],
  memberships: [
    {
      ...
      conditions: ["September pre-opening price: ₱8,190", "Non-transferable"],
      available: true,
    },
    {
      ...
      conditions: ["September pre-opening price: ₱7,280/month", "Monthly payment", "Non-transferable"],
      recommended: true,
    ...
    },
    {
      ...
      conditions: ["September pre-opening price: ₱6,370/month", "Monthly payment", "Non-transferable"],
      available: true,
    },
    {
      ...
      conditions: ["Not included in the September pre-opening promotion", "Non-transferable"],
      serviceSlug: "recovery-restore",
      available: false,
