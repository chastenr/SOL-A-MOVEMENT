...
export const launchPricing: typeof pricing = {
  introOffers: [
    {
      ...
      conditions: ["Intro pricing is not part of the September 10% promotion"],
      recommended: true,
  ...
  singleSessions: [
    {
      ...
      conditions: ["Not included in the September 10% promotion"],
  ...
  packages: [
    ...
    },
    {
      ...
      conditions: ["September promo price: ₱4,860", "Non-transferable"],
      available: true,
    },
  ],
  memberships: [
    {
      ...
      conditions: ["September promo price: ₱8,100", "Non-transferable"],
      available: true,
    },
    {
    ...
    },
    {
      ...
      conditions: ["September promo price: ₱6,300/month", "Non-transferable"],
      available: false,
      unavailableLabel: "Enrollment opens with auto-pay",
    },
    {
      ...
      conditions: ["Not included in the September 10% promotion", "Non-transferable"],
      serviceSlug: "recovery-restore",
      available: false,
